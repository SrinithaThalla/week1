...
await driver.get('file://' + dirname + '/index.html');
// Find the input elements and enter values
const num1 = await driver.findElement(webdriver.By.id('num1'));
await num1.sendKeys('50');
const num2 = await driver.findElement(webdriver.By.id('num2')); await
num2.sendKeys('10');
// Click the "Add" button
const addButton = await driver.findElement(webdriver.By.id('add')); await
addButton.click();
